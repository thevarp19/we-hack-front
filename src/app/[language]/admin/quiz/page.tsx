...
const mockQuiz: QuizType = {
    ...
    questions: [
        ...
        // Question 2
        {
            ...
            answers: [
                { answer: "Term Life Insurance", isCorrect: false },
                { answer: "Whole Life Insurance", isCorrect: true },
                {
        ...
        // Question 3
        {
            ...
            answers: [
                ...
                { answer: "The insured's job", isCorrect: false },
                {
        ...
        // Question 4
        {
            ...
            answers: [
                ...
                { answer: "The insurance agent", isCorrect: false },
                {
                    answer: "The person who receives the death benefit",
                    isCorrect: true,
                },
                { answer: "The policyholder", isCorrect: false },
            ],
        },
        // Question 5
        {
            ...
            answers: [
                ...
                { answer: "Yes, but only once", isCorrect: false },
                { answer: "Yes, at any time", isCorrect: true },
                {
